<span dropdown dropdown-append-to-body>
    <button dropdown-toggle>${ ui.message("msfcore.visitNote.changeVisit") } <i class="icon-caret-down"></i></button>
    <ul id="visit-list-dropdown" class="dropdown-menu" aria-labelledby="visit-list-dropdown">
        <li id="visit-list-full-details-element" class="list-element selectable" ng-click="goToVisitList()">${ ui.message('msfcore.visitNote.fullDetails') }</li>
